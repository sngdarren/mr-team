...
VIDEO_PATH = SCRIPT_DIR.parent / "video" / "brainrot" / "minecraft_parkour_video.mov"
RICK_IMAGE = SCRIPT_DIR.parent / "images" / "rick.png"
MORTY_IMAGE = SCRIPT_DIR.parent / "images" / "rick-and-morty-rick-morty-projectacademy-medium-17.png"
