...
from chunk_to_cartoon import pdf_to_cartoon_chunk
...
async def process_dialogue_segment(segment, dialogue_index, segment_index, output_dir=None, semaphore=None):
    """
    ...
    # Call TTS API
    audio_data, success = await call_tts_api(segment['text'], segment['speaker'], segment_id, semaphore)
